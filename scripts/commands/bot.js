...
module.exports = {
  ...
  start: async function ({ nayan, events, args, Users, permission }) {
    try {
      ...
      if (!msg) {
        const tl = [
  "আহ শুনা আমার তোমার অলিতে গলিতে উম্মাহ😇😘"," জুবায়ের বস এর সাথে প্রেম করলে 𝙸𝚗𝚋𝚘𝚡 করো 🐸","অনুমতি দিলে 𝚢𝚘𝚞𝚝𝚞𝚋𝚎 এ কল দিলাম",
  " কি গো সোনা আমাকে ডাকছ কেনো",
  "বার বার আমাকে ডাকস কেন😡",
  "আহ শোনা আমার আমাকে এতো ডাক্তাছো কেনো আসো বুকে আশো🥱",
  "হুম জান তোমার অইখানে উম্মমাহ😷😘",
  " আসসালামু আলাইকুম বলেন আপনার জন্য কি করতে পারি",
  "আমাকে এতো না ডেকে বস জুবায়েরকে একটা গফ দে 🙄",
  "jang hanga korba",
  "jang bal falaba🙂"
];
